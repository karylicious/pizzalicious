...
namespace PizzaExample
{
    ...
    public class PizzaIngrdiente
    {
        ...
        public PizzaIngrdiente()
        {
        }
        public PizzaIngrdiente(int _idpizza, int _idingred, int idPzzExistente, string _massa, string nomePizza,  string tamanho, string _Nomeingrediente, string _extra, double precoIngred, double precoPorTam, double precoT, string Origem)
        {
            id_pizza = _idpizza;
        ...
        public class Pizza
        {
            ...
            private List<PizzaIngrdiente> _items;
            ...
            public Pizza()
            {
                if (this._items == null)
                {
                    this._items = new List<PizzaIngrdiente>();
                    this._dateCreated = DateTime.Now;
                }
            }

            public List<PizzaIngrdiente> Items
            {
                get { return _items; }
                set { _items = value; }
            }
            ...
            public void Insert(string _nomePizza, int _idpizza, int _idingred, int idPzzExistente, string _massa, string tamanhoo, string _Nomeingrediente, string extra, double precoPrTam, double precoIngr, double precoT, string Origem)
            {
                    ...
                    PizzaIngrdiente NewItem = new PizzaIngrdiente();
            ...
            {
                PizzaIngrdiente Item = _items[RowID];
            ...
            {
                int index = 0;
                foreach (PizzaIngrdiente item in _items)
                {
