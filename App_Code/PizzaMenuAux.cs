...
namespace PizzaMenuExampleAux
{
    ...
    /// 
    [Serializable] 
    public class PizzaMenuExampleItemAux
    {
        ...
        public PizzaMenuExampleItemAux()
        {
        }
        public PizzaMenuExampleItemAux(int _id_ingred, int _idpizza, string _massa, string nomePizza, string tamanho, string _Nomeingrediente, string _extra)
        {
        ...
        [Serializable]
        public class PizzaMenusAux
        {
            private DateTime _dateCreated;
            private DateTime _lastUpdate;
            private List<PizzaMenuExampleItemAux> _items;


            public PizzaMenusAux()
            {
                if (this._items == null)
                {
                    this._items = new List<PizzaMenuExampleItemAux>();
                    this._dateCreated = DateTime.Now;
                }
            }

            public List<PizzaMenuExampleItemAux> Items
            {
                get { return _items; }
                set { _items = value; }
            }
            ...
            public void Insert(int _id_ingred, int _idpizza, string _massa, string _nomePizza, string _tamanho, string _Nomeingrediente, string extra)
            {
                ...
                PizzaMenuExampleItemAux NewItem = new PizzaMenuExampleItemAux();
            ...
            {
                PizzaMenuExampleItemAux Item = _items[RowID];
            ...
            {
                int index = 0;
                foreach (PizzaMenuExampleItemAux item in _items)
                {
